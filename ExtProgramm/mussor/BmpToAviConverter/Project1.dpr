...
const
  outputFileName ='D:\Реферат\В работе\MyPencil\BmpToAviConverter\TestFolder\output.avi';
var
...
begin
  ...
  try
    ...
    try
      anAviCreateParams := TAVICreateParams.Create('D:\Реферат\В работе\MyPencil\BmpToAviConverter\TestFolder',
        aFileList,12,outputFileName,'D:\Реферат\В работе\MyPencil\BmpToAviConverter\TestFolder',0, 640,480);
