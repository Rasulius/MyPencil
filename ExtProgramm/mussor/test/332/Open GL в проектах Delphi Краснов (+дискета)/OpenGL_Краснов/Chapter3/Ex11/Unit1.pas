...
procedure TfrmGL.btnOrthoClick(Sender: TObject);
begin
 glLoadIdentity;
...
procedure TfrmGL.btnOrtho2DClick(Sender: TObject);
begin
 glLoadIdentity;
...
procedure TfrmGL.btnFrustumClick(Sender: TObject);
begin
 glLoadIdentity;
...
procedure TfrmGL.btnPerspectiveClick(Sender: TObject);
begin
 glLoadIdentity;
 // задаем перспективу
