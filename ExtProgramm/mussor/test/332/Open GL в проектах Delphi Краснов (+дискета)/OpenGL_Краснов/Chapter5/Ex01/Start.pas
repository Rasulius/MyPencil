// стартовая процедура загрузки библиотеки InitRC и чтения данных из файла
...
begin
  ...
  If FindFirstFile ('ARM.dat', wrk) <> INVALID_HANDLE_VALUE then
  try
  ...
  If  flgFileError then begin  // Ошибка чтения файла
